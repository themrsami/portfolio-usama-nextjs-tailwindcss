...
const Portfolio = () => {
  ...
  return (
    <>
      <section className="py-3 mb-24">
        <div className="container px-4 mx-auto">
          <div className="flex flex-wrap -mx-3 -mb-8">
            <div className="w-full md:w-1/2 lg:w-1/4 px-3 mb-8">
              <div className={`animateltr max-w-sm mx-auto h-full px-4 pt-6 pb-24 ${gridsbackground} rounded-xl`}>
                <div className="flex items-center justify-between mb-3">
                  <div className="flex items-center">
                    <h3 className={`text-lg ${headingtext} font-semibold mr-2`}>To do</h3>
                ...
                <a className="block p-4 mb-4 bg-gray-600 rounded-xl hover:bg-gray-700 transition duration-200" href="#">
                  ...
                  <p className="text-xs text-gray-300 leading-normal mb-10"></p>
                  <div className="pt-4 border-t border-gray-500">
                    <div className="flex flex-wrap items-center justify-between -m-2">
                      <div className="w-auto p-2">
                        <div className={`flex items-center p-2 ${gridsbackground} rounded-md`}>
                          ...
                          <span className={`ml-2 text-xs font-medium ${tabbuttoncolor} `}>Jul 03</span>
                        </div>
                      </div>
                      <div className="w-auto p-2">
                        <div className="flex h-full items-center">
                          <Image className="w-7 h-7 rounded-full object-cover" src="/images/avatar-men-circle-border.png" width={42} height={42} alt=""/>
                          <Image className="w-7 h-7 -ml-3 rounded-full object-cover" src="/images/avatar-women-circle-border.png" width={43} height={42} alt=""/>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="flex flex-wrap items-center justify-between -m-2">
                      <div className="w-auto p-2">
                        <div className={`flex items-center p-2 ${gridsbackground} rounded-md`}>
                          ...
                          <span className={`ml-2 text-xs font-medium ${tabbuttoncolor} `}>Jul 04</span>
                        </div>
                      </div>
                      <div className="w-auto p-2">
                        <div className="flex h-full items-center">
                          <Image className="w-7 h-7 rounded-full object-cover" src="/images/avatar-women-2-circle-border.png" width={48} height={48} alt=""/>
                          <Image className="w-7 h-7 -ml-3 rounded-full object-cover" src="/images/avatar-women-3-circle-border.png" width={48} height={48} alt=""/>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="flex flex-wrap items-center justify-between -m-2">
                      <div className="w-auto p-2">
                        <div className={`flex items-center p-2 ${gridsbackground} rounded-md`}>
                          ...
                          <span className={`ml-2 text-xs font-medium ${tabbuttoncolor} `}>Jul 05</span>
                        </div>
                      </div>
                      <div className="w-auto p-2">
                        <div className={`inline-flex items-center justify-center w-8 h-8 ${gridsbackground} rounded-full`}>
                          <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="w-full md:w-1/2 lg:w-1/4 px-3 mb-8">
              <div className={`animatey max-w-sm mx-auto h-full px-4 pt-6 pb-24 ${gridsbackground} rounded-xl`}>
                <div className="flex items-center justify-between mb-3">
                  <div className="flex items-center">
                    <h3 className={`text-lg ${headingtext} font-semibold mr-2`}>In progress</h3>
                ...
                <a className="block p-4 mb-4 bg-gray-600 rounded-xl hover:bg-gray-700 transition duration-200" href="#">
                  ...
                  <div className="pt-4 border-t border-gray-500">
                    <div className="flex flex-wrap items-center justify-between -m-2">
                      ...
                      <div className="w-auto p-2">
                        <div className="flex h-full items-center">
                          <Image className="w-7 h-7 rounded-full object-cover" src="/images/avatar-women-3-circle-border.png" width={48} height={48} alt=""/>
                          <Image className="w-7 h-7 -ml-3 rounded-full object-cover" src="/images/avatar-women-circle-border.png" width={43} height={42} alt=""/>
                        </div>
                      </div>
                    </div>
                ...
                <a className="block p-4 mb-4 bg-gray-600 rounded-xl hover:bg-gray-700 transition duration-200" href="#">
                  ...
                  <Image className="block w-full h-28 object-cover rounded-md mb-3" src="/images/laptop-photo-placeholder.png" width={301} height={170} alt=""/>
                  ...
                  <div className="pt-4 border-t border-gray-500">
                    <div className="flex flex-wrap items-center justify-between -m-2">
                      ...
                      <div className="w-auto p-2">
                        <div className="flex h-full items-center">
                          <Image className="w-7 h-7 rounded-full object-cover" src="/images/avatar-women-circle-border.png" width={43} height={42} alt=""/>
                          <Image className="w-7 h-7 -ml-3 rounded-full object-cover" src="/images/avatar-men-2-circle-border.png" width={54} height={55} alt=""/>
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            <div className="w-full md:w-1/2 lg:w-1/4 px-3 mb-8">
              <div className={`animatettb max-w-sm mx-auto h-full px-4 pt-6 pb-24 ${gridsbackground} rounded-xl`}>
                <div className="flex items-center justify-between mb-3">
                  <div className="flex items-center">
                    <h3 className={`text-lg ${headingtext} font-semibold mr-2`}>In Review</h3>
                ...
                <a className="block p-4 mb-4 bg-gray-600 rounded-xl hover:bg-gray-700 transition duration-200" href="#">
                  <Image className="block w-full h-28 object-cover rounded-md mb-3" src="/images/working-women-laptop.png" width={303} height={171} alt=""/>
            ...
            <div className="w-full md:w-1/2 lg:w-1/4 px-3 mb-8">
              <div className={`animatex max-w-sm mx-auto h-full px-4 pt-6 pb-24 ${gridsbackground} rounded-xl`}>
                <div className="flex items-center justify-between mb-3">
                  <div className="flex items-center">
                    <h3 className={`text-lg ${headingtext} font-semibold mr-2`}>In progress</h3>
                    <span className="inline-flex items-center justify-center w-6 h-7 rounded-full bg-gray-600 text-xs font-medium text-gray-400">2</span>
